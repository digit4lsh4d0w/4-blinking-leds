...
//     // active_led_t simple_led_next_state = (ctx->current_state + 1) % LED_STATE_COUNT;
//     // ctx->current_state = simple_led_next_state;

//     active_breath_led_t breath_led_next_state = (ctx->current_breath_state + 1) % BREATH_LED_STATE_COUNT;
//     ctx->current_breath_state = breath_led_next_state;
// }
